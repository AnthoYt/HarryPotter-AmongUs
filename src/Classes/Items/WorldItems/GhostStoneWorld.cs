...
namespace HarryPotter.Classes.WorldItems
{
    public class GhostStoneWorld : WorldItem
    {
        ...
        public GhostStoneWorld(Vector2 position)
        {
            ...
            this.Name = "Resurrection Stone"; // Nom de l'objet
        }
        ...
        public static void WorldSpawn()
        {
            ...
            Main.Instance.RpcSpawnItem(4, pos); // Appel pour spawn l'objet à la position choisie
        ...
        public static bool CanSpawn()
        {
            ...
            if (Main.Instance.AllItems.Any(x => x.Id == 4))
                return false;
